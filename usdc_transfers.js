...
const TOKEN_ADDRESS = "0xd988097fb8612cc24eeC14542bC03424c656005f"; // USDC address
...
// CSV file setup
const CSV_FILENAME = "usdc_transfers.csv";
const CSV_HEADERS = "block_number,timestamp,tx_hash,from_address,to_address,amount\n";

const main = async () => {
  console.log("Starting USDC Transfer event tracking...");
