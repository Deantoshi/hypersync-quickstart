...
const TOKEN_ADDRESS = "0xA70266C8F8Cf33647dcFEE763961aFf418D9E1E4"; // iUSD address
...
// CSV file setup
const CSV_FILENAME = "iusd_transfers.csv";
const CSV_HEADERS = "block_number,timestamp,tx_hash,from_address,to_address,amount\n";

const main = async () => {
  console.log("Starting iUSD Transfer event tracking...");
